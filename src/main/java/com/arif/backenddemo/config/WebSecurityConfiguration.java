package com.arif.backenddemo.config;


import com.arif.backenddemo.security.AuthenticationTokenFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/auth/**", "/user/me", "/user/checkusernameavailability**").permitAll()
